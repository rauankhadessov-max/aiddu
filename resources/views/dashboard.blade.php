    ...
    <div class="space-y-8">
                ...
                <div class="rounded-2xl border border-white/10 bg-white/5 p-6">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <span class="rounded-full bg-slate-500/20 px-3 py-1 text-xs font-semibold text-slate-300">
                                Следующий этап
                            </span>
                        </div>
                    </div>
        ...
        <section>
            ...
            <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <a href="#" class="rounded-2xl border border-slate-200 bg-white p-6 transition hover:border-blue-300 hover:shadow-md">
