    ...
    <div class="mx-auto max-w-4xl">
        ...
        <section class="rounded-2xl border border-slate-200 bg-white p-6">
            <form
                ...
                class="space-y-7"
                x-data="{ inputMethod: @js(old('input_method', 'docx')) }"
            >
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Наименование нормативного правового акта"
                    >
                </div>
                ...
                <div x-show="inputMethod === 'url'">
                    ...
                    <p class="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-800">
                        Ссылка будет сохранена как официальный источник. Для использования НПА в юридическом анализе необходимо добавить редакцию нормативного текста.
                    </p>
                </div>

                <div class="flex flex-wrap gap-3">
                    <button type="submit" class="rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-500">Добавить в нормативную базу</button>
                    <a href="{{ route('sources.index') }}" class="rounded-xl border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-700">Отмена</a>
                </div>
            </form>
        </section>
    </div>
