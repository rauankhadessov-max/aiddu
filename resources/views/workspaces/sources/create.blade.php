        ...
        <section class="ui-card">
            <form method="POST" action="{{ route('workspaces.sources.store', $workspace) }}" enctype="multipart/form-data" class="space-y-7" x-data="{ inputMethod: @js(old('input_method', 'docx')) }">
                ...
                <div>
                    ...
                    <input id="title" type="text" name="title" value="{{ old('title') }}" required class="ui-input mt-2" placeholder="Наименование нормативного правового акта">
                </div>

                <div>
                    <label for="type" class="text-sm font-semibold text-slate-700">Вид НПА</label>
                    <select id="type" name="type" required class="ui-input mt-2">
                ...
                <div x-show="inputMethod === 'url'">
                    ...
                    <input id="official_url" type="url" name="official_url" value="{{ old('official_url') }}" class="ui-input mt-2" placeholder="https://adilet.zan.kz/...">
                ...
                <div class="flex flex-wrap gap-3">
                    <button type="submit" class="ui-btn-primary">Добавить НПА</button>
                    <a href="{{ route('workspaces.sources', $workspace) }}" class="ui-btn-secondary">Отмена</a>
                </div>
            </form>
        </section>
    </div>
